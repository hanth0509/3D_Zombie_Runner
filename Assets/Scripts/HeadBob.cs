...
{
    [SerializeField] private float amplitude = 0.02f;    // độ cao rung
    [SerializeField] private float frequency = 8f;       // tốc độ rung
    ...
    private void Update()
    {
        ...
        else
        {
            ...
            transform.localPosition = Vector3.Lerp(
                transform.localPosition, startPos, Time.deltaTime * 5f);
        }
    }
}
